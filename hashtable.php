...
echo "<script type=module src='./sortable-table.js'></script><div style=overflow-x:scroll>\n<table is=sortable-table>";
echo '<thead><tr><th>Hash Algorithm<th>Encoding<th>Identifier<th>Alternate identifier<th>Multibase (if applicable)</thead><tbody>';
$bases = [
